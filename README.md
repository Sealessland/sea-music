...
<!-- benchmark-ci:start -->
> 最近一次通过门禁的 CI 基准：[workflow run](https://github.com/Sealessland/sea-music/actions/runs/29677814363) · `4fcffd64716d` · 2026-07-19T07:21:53Z
...
|---|---:|---:|---:|---:|---:|---:|---|
| `cache` | 3 | 200.02 | 0.98 ms | 1.74 ms | 0.0000% | 0 | 通过 |
| `no-cache` | 3 | 200.02 | 1.43 ms | 2.44 ms | 0.0000% | 0 | 通过 |

缓存相对无缓存：P95 `-31.18%`，P99 `-28.55%`（负值表示延迟降低）。
<!-- benchmark-ci:end -->
