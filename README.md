...
<!-- benchmark-ci:start -->
> 最近一次通过门禁的 CI 基准：[workflow run](https://github.com/Sealessland/sea-music/actions/runs/29817402768) · `c282558546f2` · 2026-07-21T09:19:28Z
...
|---|---:|---:|---:|---:|---:|---:|---|
| `cache` | 3 | 200.02 | 0.83 ms | 1.63 ms | 0.0000% | 0 | 通过 |
| `no-cache` | 3 | 200.02 | 1.14 ms | 1.95 ms | 0.0000% | 0 | 通过 |

缓存相对无缓存：P95 `-27.75%`，P99 `-16.40%`（负值表示延迟降低）。
<!-- benchmark-ci:end -->
