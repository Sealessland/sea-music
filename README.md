...
<!-- benchmark-ci:start -->
> 最近一次通过门禁的 CI 基准：[workflow run](https://github.com/Sealessland/sea-music/actions/runs/32688610576) · `a9084db3ea32` · 2026-08-24T04:09:43Z
...
|---|---:|---:|---:|---:|---:|---:|---|
| `cache` | 3 | 200.02 | 1.17 ms | 1.88 ms | 0.0000% | 0 | 通过 |
| `no-cache` | 3 | 200.02 | 1.57 ms | 2.57 ms | 0.0000% | 0 | 通过 |

缓存相对无缓存：P95 `-25.54%`，P99 `-27.03%`（负值表示延迟降低）。
<!-- benchmark-ci:end -->
